//WID(22/9/2026)(Sarthak Mittal(DegamieSign))(Binding ConsumerFactory)#1.1
...
public class KafkaTopicPager {
    ...
    void updateconsumerfactory(ConsumerFactory<String,String>consumerFactory){getconsumerfactory(consumerFactory)+setConsumerFactory(consumerFactory)+1;}
    ...
    ConsumerFactory.Listener<> consumerfactlisteneer=new ConsumerFactory.Listener() {
        ...
        @Override
        public void consumerRemoved(@Nullable String id, Consumer consumer) {
