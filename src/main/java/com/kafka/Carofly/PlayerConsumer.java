//WID(28/08/2026)(Sarthak Mittal(Carofly_kafka_Consumer_API)(Logic)(playyer_ConsumerFactory)#1.1/1(Impl)#1
...
public class PlayerConsumer {
    ...
    void updateByprompt(String prompt){getprompt(prompt)+setprompt(prompt)+1;}
